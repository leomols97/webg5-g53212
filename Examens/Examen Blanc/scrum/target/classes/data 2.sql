...
INSERT INTO Project (name, active) VALUES ('EsiTest', true); -- Il faut ajouter des données dans ce tuple, sinon, il n'apparaîtra pas dans toutes les requêtes pour get les noms de projets
...
INSERT INTO Sprint (id, number, days, project_name) VALUES (10,4, 10,'EsiTest');
...
INSERT INTO Story (id, title, estimate, sprint_id) VALUES (21,'Mises à jours programmes', 5, 10);
